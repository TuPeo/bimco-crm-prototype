...
export default function CreateEventModal({ isOpen, onClose, onSave, segmentName }: CreateEventModalProps) {
  ...
  const eventTypes = ['Meeting', 'Call', 'Presentation', 'Workshop', 'Training', 'Review'];
